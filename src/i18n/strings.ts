...
const en: Strings = {
  ...
  privacyCookiesBody: 'We set a signed cookie that keeps you signed in, plus one that remembers you closed the Android app banner. We do not use any analytics, advertising, or tracking cookies.',
  ...
  privacyRetentionProfiles: 'Opinios are deleted automatically after 6 months.',
  ...
  termsRulesIntro: 'When you submit an opinio, statement, photo, or description, the following are not allowed:',
  ...
  termsRuleImpersonationBody: 'do not pretend to be someone else, and do not submit opinios designed to deceive.',
  ...
  displayNameFormat: 'Only lowercase letters, numbers, and underscores (4-30 characters)',
  ...
  seo: {
    ...
    support: {
      ...
      description: 'Contact Opinio support, manage your tickets, and get help with voting, opinions, and account settings.',
    },
    signIn: {
...
const cs: Strings = {
  ...
  privacyCookiesBody: 'Nastavujeme podepsanou cookie pro přihlášení a jednu, která si pamatuje, že jsi zavřel nabídku aplikace pro Android. Žádné analytické, reklamní ani sledovací cookies.',
  ...
  privacyRetentionProfiles: 'Opinio mažeme automaticky po 6 měsících.',
  ...
  termsRulesIntro: 'Když přidáváte opinio, výrok, fotku nebo popis, není dovoleno následující:',
  ...
  termsRuleImpersonationBody: 'nevydávejte se za jiné osoby a nevytvářejte opinio určená k oklamání ostatních.',
  ...
  displayNameFormat: 'Pouze malá písmena, číslice a podtržítka (4-30 znaků)',
  ...
  seo: {
    ...
    support: {
      ...
      description: 'Kontaktujte podporu Opinio, spravujte své tikety a získejte pomoc s hlasováním, názory a nastavením účtu.',
    },
    signIn: {
      title: 'Přihlášení - Opinio',
      description: 'Přihlaste se na Opinio přes Google nebo Microsoft, abyste mohli hlasovat, přidávat názory a sledovat svou aktivitu.',
    },
  },
};
...
const es: Strings = {
  ...
  privacyCookiesTitle: 'Cookies',
  privacyCookiesBody: 'Establecemos una cookie firmada que mantiene tu sesión iniciada y otra que recuerda que cerraste el aviso de la aplicación de Android. No utilizamos ninguna cookie de analítica, publicidad ni seguimiento.',
  ...
  privacyRetentionProfiles: 'Los opinio se eliminan automáticamente tras 6 meses.',
  ...
  termsRulesIntro: 'Cuando envías un opinio, una afirmación, una foto o una descripción, lo siguiente no está permitido:',
  ...
  termsRuleImpersonationBody: 'no te hagas pasar por otra persona ni crees opinio diseñados para engañar.',
  ...
  displayNameFormat: 'Solo letras minúsculas, números y guiones bajos (4-30 caracteres)',
  ...
  seo: {
    ...
    support: {
      ...
      description: 'Contacta con el soporte de Opinio, gestiona tus tickets y obtén ayuda con la votación, las opiniones y la configuración de tu cuenta.',
    },
    signIn: {
      title: 'Iniciar sesión - Opinio',
      description: 'Inicia sesión en Opinio con Google o Microsoft para votar, publicar opiniones y seguir tu actividad.',
    },
  },
};
...
const de: Strings = {
  ...
  privacyCookiesTitle: 'Cookies',
  privacyCookiesBody: 'Wir setzen ein signiertes Cookie, das dich angemeldet hält, und eines, das sich merkt, dass du den Hinweis auf die Android-App geschlossen hast. Wir verwenden keine Analyse-, Werbe- oder Tracking-Cookies.',
  ...
  privacyRetentionProfiles: 'Opinio werden nach 6 Monaten automatisch gelöscht.',
  ...
  termsRulesIntro: 'Wenn du ein opinio, eine Aussage, ein Foto oder eine Beschreibung einreichst, ist Folgendes nicht erlaubt:',
  ...
  termsRuleImpersonationBody: 'gib dich nicht als jemand anderes aus und reiche keine opinio ein, die zur Täuschung dienen.',
  ...
  displayNameFormat: 'Nur Kleinbuchstaben, Zahlen und Unterstriche (4-30 Zeichen)',
  ...
  seo: {
    ...
    support: {
      title: 'Support - Opinio',
      description: 'Kontaktiere den Opinio-Support, verwalte deine Tickets und erhalte Hilfe bei Abstimmungen, Meinungen und Kontoeinstellungen.',
    },
    signIn: {
      title: 'Anmelden - Opinio',
      description: 'Melde dich bei Opinio mit Google oder Microsoft an, um abzustimmen, Meinungen zu posten und deine Aktivität zu verfolgen.',
    },
  },
};
...
const fr: Strings = {
  ...
  privacyCookiesTitle: 'Cookies',
  privacyCookiesBody: "Nous déposons un cookie signé qui vous garde connecté et un autre qui retient que vous avez fermé la bannière de l'application Android. Nous n'utilisons aucun cookie d'analyse, de publicité ou de pistage.",
  ...
  privacyRetentionProfiles: 'Les opinios sont supprimés automatiquement après 6 mois.',
  ...
  termsRulesIntro: 'Lorsque vous soumettez un opinio, une affirmation, une photo ou une description, les éléments suivants sont interdits :',
  ...
  termsRuleImpersonationBody: "ne vous faites pas passer pour quelqu'un d'autre et ne soumettez pas d'opinios destinés à tromper.",
  ...
  displayNameFormat: 'Uniquement des minuscules, des chiffres et des tirets bas (4-30 caractères)',
  ...
  seo: {
    ...
    support: {
      ...
      description: "Contactez l'assistance Opinio, gérez vos tickets et obtenez de l'aide pour le vote, les opinions et les paramètres de compte.",
    },
    signIn: {
      title: 'Connexion - Opinio',
      description: 'Connectez-vous à Opinio avec Google ou Microsoft pour voter, publier des opinions et suivre votre activité.',
    },
  },
};
...
const it: Strings = {
  ...
  privacyCookiesBody: "Impostiamo un cookie firmato che ti mantiene connesso e uno che ricorda che hai chiuso l'avviso dell'app Android. Non utilizziamo alcun cookie di analisi, pubblicità o tracciamento.",
  ...
  privacyRetentionProfiles: 'Gli opinios vengono eliminati automaticamente dopo 6 mesi.',
  ...
  termsRulesIntro: 'Quando invii un opinio, un\'affermazione, una foto o una descrizione, sono vietati i seguenti elementi:',
  ...
  termsRuleImpersonationBody: 'non spacciarti per qualcun altro e non inviare opinios destinati a ingannare.',
  ...
  displayNameFormat: 'Solo lettere minuscole, numeri e trattini bassi (4-30 caratteri)',
  ...
  seo: {
    ...
    support: {
      ...
      description: 'Contatta l\'assistenza Opinio, gestisci i tuoi ticket e ottieni aiuto per il voto, le opinioni e le impostazioni dell\'account.',
    },
    signIn: {
      title: 'Accesso - Opinio',
      description: 'Accedi a Opinio con Google o Microsoft per votare, pubblicare opinioni e seguire la tua attività.',
    },
  },
};
...
const pl: Strings = {
  ...
  privacyCookiesBody: 'Ustawiamy podpisany plik cookie, który utrzymuje Cię zalogowanym, oraz jeden, który zapamiętuje zamknięcie informacji o aplikacji na Androida. Nie używamy żadnych plików cookie analitycznych, reklamowych ani śledzących.',
  ...
  privacyRetentionProfiles: 'Opinio usuwamy automatycznie po 6 miesiącach.',
  ...
  termsRulesIntro: 'Gdy przesyłasz opinio, wypowiedź, zdjęcie lub opis, niedozwolone są:',
  ...
  termsRuleImpersonationBody: 'nie udawaj kogoś innego i nie przesyłaj opinio mających na celu wprowadzenie w błąd.',
  ...
  displayNameFormat: 'Tylko małe litery, cyfry i podkreślenia (4-30 znaków)',
  ...
  seo: {
    ...
    support: {
      title: 'Pomoc - Opinio',
      description: 'Skontaktuj się z pomocą Opinio, zarządzaj zgłoszeniami i uzyskaj pomoc w głosowaniu, opiniach i ustawieniach konta.',
    },
    signIn: {
      title: 'Logowanie - Opinio',
      description: 'Zaloguj się do Opinio przez Google lub Microsoft, aby głosować, publikować opinie i śledzić swoją aktywność.',
    },
  },
};
